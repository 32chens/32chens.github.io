...
1. prepareRefresh                          创建成员变量Environment 对象

2. obtainFreshBeanFactory            获取（或创建） 成员变量BeanFactory, 主要将所有BeanDefinition 存入beanDefinitionMap 集合

3. prepareBeanFactory                   为BeanFactory的各项成员变量赋值

4. postProcessBeanFactory           空实现,容器子类实现
...
9. onRefresh                                    空实现,容器子类实现

10. registerListeners                           注册监听器到广播器

11. finishBeanFactoryInitialization      初始化单例bean

12. finishRefresh                                添加声明周期管理bean
...
![image-20210902181639048](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100873.png)
...
![image-20210902182004819](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100880.png)
...
![image-20210902182541925](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100894.png)
...
![image-20210902183232114](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100899.png)
...
![image-20210902183520307](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100903.png)
...
![image-20210902183819984](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100910.png)
...
![image-20210902183943469](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100937.png)
...
![image-20210902184343872](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100956.png)
...
![image-20210902184641623](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100960.png)
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100947.png" alt="image-20210903085238916" style="zoom:50%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100948.png" alt="image-20210903085454603" style="zoom: 33%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100620.png" alt="image-20210903091627659" style="zoom: 50%;" />

* 思路2
  * a 注入 b 的工厂对象，让 b 的实例创建被推迟，这样能够保证 a 的流程先走通
  * 后续需要用到 b 的真实对象时，再通过 ObjectFactory 工厂间接访问

<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100673.png" alt="image-20210903091743366" style="zoom:50%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100699.png" alt="image-20210903100752165" style="zoom:80%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100723.png" alt="image-20210903100914140" style="zoom:80%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100756.png" alt="image-20210903101849924" style="zoom:80%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100859.png" alt="image-20210903103030877" style="zoom:80%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100996.png" alt="image-20210903120436365" style="zoom: 50%;" />
...
![image-20210903120800185](https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100198.png)
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100217.png" alt="image-20210903140657163" style="zoom: 80%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100245.png" alt="image-20210903141017502" style="zoom:80%;" />

3. 将 HandlerMethod 连同匹配到的拦截器，生成调用链对象 HandlerExecutionChain 返回

<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100264.png" alt="image-20210903141124911" style="zoom:80%;" />

4. 遍历HandlerAdapter 处理器适配器，找到能处理 HandlerMethod 的适配器对象，开始调用

<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100389.png" alt="image-20210903141204799" style="zoom:80%;" />

**调用阶段**

1. 执行拦截器 preHandle

<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100451.png" alt="image-20210903141445870" style="zoom: 67%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100559.png" alt="image-20210903141658199" style="zoom:67%;" />
...
<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100628.png" alt="image-20210903141749830" style="zoom:67%;" />

4. 第 2 步有异常，进入 HandlerExceptionResolver 异常处理流程

<img src="https://hexo-chenlf.oss-cn-shanghai.aliyuncs.com/img/202309142100649.png" alt="image-20210903141844185" style="zoom:67%;" />
